    ...
    <div>
      ...
      {sites.length === 0 ? (
        <div className="bg-surface rounded-xl border border-border px-6 py-16 text-center">
          ...
          <h3 className="text-lg font-semibold text-text mb-1">No sites yet</h3>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs text-text-muted font-mono mt-0.5">{site.code}</p>
                  </div>
                ...
                <div className="flex gap-4 text-sm pt-3 border-t border-border-light">
                  <div>
                    <span className="font-semibold text-text">{c.buildings}</span>
                    <span className="text-text-secondary ml-1">building{c.buildings !== 1 ? "s" : ""}</span>
                  </div>
                  <div>
                    <span className="font-semibold text-text">{c.meters}</span>
                    <span className="text-text-secondary ml-1">meter{c.meters !== 1 ? "s" : ""}</span>
                  </div>
                </div>
